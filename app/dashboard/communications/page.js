...
export default function CommunicationsPage() {
  ...
  const getTypeIcon = (type) => {
    switch(type) {
      ...
      case 'phone': return <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4" />;
      case 'chat': return <MessageCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4" />;
      case 'whatsapp': return <Send className="w-3.5 h-3.5 sm:w-4 sm:h-4" />;
      default: return <MessageSquare className="w-3.5 h-3.5 sm:w-4 sm:h-4" />;
    }
  };
  ...
  const typeOptions = [
    ...
    { value: 'phone', label: texts.phone, icon: <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> },
    { value: 'chat', label: texts.chat, icon: <MessageCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> },
    { value: 'whatsapp', label: texts.whatsapp, icon: <Send className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> }
  ];
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                required
                rows="4"
                className={`w-full pl-9 sm:pl-11 pr-3 sm:pr-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-lg border-2 transition-colors resize-none outline-none ${
                  darkMode
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">            <button
            ...
            {editingId && (
              <button
                ...
                className={`px-4 sm:px-6 py-2 sm:py-2.5 text-sm sm:text-base rounded-lg font-semibold transition-all flex items-center gap-2 ${                  darkMode
      ...
      {/* COMMUNICATIONS LIST */}
      <div className={`rounded-2xl overflow-hidden shadow-xl transition-all duration-300 ${        darkMode ? 'bg-slate-800' : 'bg-white'
      }`}>
